...
# Started from https://github.com/mathiasbynens/dotfiles/blob/master/.osx
...
DesktopViewSettings:IconViewSettings:labelOnBottom true" ~/Library/Preferences/com.apple.finder.plist
